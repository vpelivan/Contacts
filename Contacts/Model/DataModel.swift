...
struct User {
    ...
    // MARK: - This method randomizes part of user data using RandomData class
...
private class RandomData {
    ...
    // Users randlomly given nick names being used to generate a fake email adress
    ...
    // Users randlomly given mail servers being used to generate a fake email adress
    let serversArray: [String] = ["@hotmail.com", "@yahoo.com", "@gmail.com", "@ukr.net", "@yandex.ru", "@mail.ru", "@outlook.com", "@aol.com", "@icloud.com", "@gmx.com"]
    
    // Users randlomly given online/offline statuses
    let statusArray: [Bool] = [true, false]
    
    // Real Gravatar accounts being hashed later to perform requests
